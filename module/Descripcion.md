...
#### 1. Función Principal: `Invoke-WhisperTranslator`
...
- El usuario ejecuta `Invoke-WhisperTranslator` con parámetros opcionales
...
- Únicamente `Invoke-WhisperTranslator` es exportada como función pública
